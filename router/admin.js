...
* CREATE PROVIDER
* 
* Adapter sekarang FLEXIBLE.
* 
* Tidak harus sudah terdaftar di registry.
* Registry/generator akan menentukan apakah
* implementasi adapter benar-benar tersedia.
* ---
...
/*
 * Jika adapter tidak diisi,
 * coba infer dari nama atau ID provider.
 */
if (!adapterValue) {
  const inferred =
    inferAdapter(
 ...
 *
 * Tidak lagi menggunakan adapterInfo()
 * karena adapter baru boleh disimpan sebelum
 * implementasinya dibuat.
 */
if (!adapterValue) {
  throw new HttpError(
    "Adapter wajib diisi.",
 ...
 *   seedance
 *
 * Tidak membatasi daftar provider.
 */
if (
  ...
  throw new HttpError(
    "ID adapter tidak valid. Gunakan 2-64 karakter berupa huruf kecil, angka, underscore, atau tanda minus.",
    400
  );
}
