  ...
  new Promise(
    function (resolve, reject) {
      ...
      if (existing) {
        ...
        /* -----------------------------------------------
           Module mungkin sudah tersedia setelah script
           dieksekusi.
           ----------------------------------------------- */
        ...
        /* -----------------------------------------------
           Jika script sudah pernah berhasil dimuat,
           jangan menunggu event load yang sudah lewat.
           ----------------------------------------------- */
        ...
        /* -----------------------------------------------
           Script masih dalam proses loading
           ----------------------------------------------- */
...
/* -----------------------------------------------------
   Simpan promise khusus Top Up Setting
   ----------------------------------------------------- */
